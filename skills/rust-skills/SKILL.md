...
name: rust-skills
description: >
  You must reference these guidelines when writing Rust. Follow the appropriate 265 rules/ and use when writing, reviewing, or refactoring Rust code. Covers ownership,
...
See rules/ and take into account what's relevant for the task.
